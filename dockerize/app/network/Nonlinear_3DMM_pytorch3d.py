...
class Nonlinear3DMM_pytorch3d(nn.Module):
    def __init__(self, gf_dim=32, df_dim=32, gfc_dim=512, dfc_dim=512, nz=3, trans_dim=3, rot_dim=3, il_dim=27,
        ...
        self.shape_dec = NLDecoderBlock(self.gfc_dim // 2, self.gf_dim, self.gfc_dim * 10, self.tex_sz)
        ...
        self.exp_dec = NLDecoderBlock(self.gfc_dim // 2, self.gf_dim, self.gfc_dim * 10, self.tex_sz)
    ...
    def to(self, device, *args, **kwargs):
        ret = super(Nonlinear3DMM_pytorch3d, self).to(device, *args, **kwargs)
